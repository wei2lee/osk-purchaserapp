...
faker.image.event = function() {
    var arr = [
        'Emira.jpg',
        'Web_Cover_Merdeka_Kids_Colouring_Contest_R1-01.jpg',
        'Webpage_light_box.jpg',
    ];
    return 'img/osk/DeveloperTrackRecord/watsnew/' + arr[_.random(arr.length - 1)];
};
...
'Gravitas.jpg',
'Opus2.jpg',
'Pangaea_Overview.jpg',
'The_Vale.jpg',
'emira.png',
'mirage_by_the_lake.jpg',
'mirage_residence.jpg',
        ];

    return 'img/osk/DeveloperTrackRecord/properties/' + arr[_.random(arr.length - 1)];
}
